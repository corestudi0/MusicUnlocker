(function(t) {
	...
	2: function(t, e) {},
	"2e83": function(t, e, r) {
		t.exports = r.p + "js/0-legacy.75478485.worker.js"
	},
	3: function(t, e) {},
	4: function(t, e) {},
	5: function(t, e) {},
							...
							switch (n.label) {
								...
								case 1:
									if (e = n.sent(), r = !e.common.album && !e.common.artists && !e.common.title, r || this.newMeta.picture) {
										if ("mp3" === this.format) this.audio = Object(i["j"])(t.from(this.audio), this.newMeta, e);
										else {
				...
				return Object(n["c"])(this, (function(n) {
					switch (n.label) {
						case 0:
							...
							]), [4, fetch("".concat(a, "?").concat(o.toString()))];
						case 1:
			...
			a = function(t) {
				...
				return Object(n["b"])(e, t), Object.defineProperty(e, "works", {
					...
					return Object(n["a"])(this, void 0, Promise, (function() {
						var t, e, r, a, o, c, s;
						return Object(n["c"])(this, (function(n) {
							for (t = {}, e = 0, r = Object.entries(localStorage); e < r.length; e++)
								if (a = r[e], o = a[0], c = a[1], o.startsWith(i["a"])) try {
	...
	fa01: function(t, e, r) {
		...
		(function(t) {
			...
			function s(t, e) {
				...
				for (p = 1; p <= a; p++)
					if (o[b] != f[b]) throw Error("zero check failed");
				return l
			}
		}).call(this, r("1c35").Buffer)
	}
